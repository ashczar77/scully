...
- Active step: Step 4.4, reliability and clean setup
- Next checkpoint: Gate G4.4, reliability review
...
boundary and authorized Step 4.4 reliability and clean setup only.
